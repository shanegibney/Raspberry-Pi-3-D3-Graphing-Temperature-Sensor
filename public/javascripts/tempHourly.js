/*    /opt/nodeserver/expressTempApp/tempApp/public/javascripts/tempHourly.js     */
...
var radius = 4;
  ...
  function(info) {
    ...
    // Beginning of graph for hourly averages over 30 days
    var margin = {
        top: 50,
        right: 20,
        bottom: 90,
    ...
    svg.append("text") // text label for title
      ...
      .style("font-size", "19")
      .style("text-anchor", "middle")
      .text("Temperature Readings - previous 24 hours")
    ...
    svg.append("g")
      .attr("transform", "translate(0," + height + ")")
      .call(d3.axisBottom(xScale).ticks(14).tickFormat(d3.timeFormat("%a %H:%M")))
      .selectAll("text")
