/*    /opt/nodeserver/expressTempApp/tempApp/public/javascripts
/temp5mins.js     */
...
var radius = 4;
  ...
  function(info) {
    ...
    svg.append("text") // text label for title
      ...
      .style("font-size", "19")
      .style("text-anchor", "middle")
      .text("Temperature Readings - previous hour")
    ...
    svg.append("g")
      .attr("transform", "translate(0," + height + ")")
      .call(d3.axisBottom(xScale).ticks(13).tickFormat(d3.timeFormat("%H:%M")))
      .selectAll("text")
